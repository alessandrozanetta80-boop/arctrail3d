...
| `vetrina-anteprima_2026-08-25.html` | `vetrina.html` | Anteprima della vetrina (`2026-08-25-vetrina-vere`, `noindex`). | Non è più una pagina del sito dal 25/08 (`docs/STATO.md`): la vetrina vera è `index.html`. Tenuta come fotografia di quella versione. |
