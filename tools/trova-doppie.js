 ...
 *
 *   node tools/trova-doppie.js            legge compagnie-data.js e stampa l'elenco
 *   node tools/trova-doppie.js --scrivi   riscrive DOPPIE-TESSERE-ITALIA.md
 *
...
righe.push("");
righe.push("*Rigenerato da `node tools/trova-doppie.js --scrivi`. Non si corregge a mano:");
...
var DOPPIE = require("path").join(__dirname, "..", "docs", "DOPPIE-TESSERE-ITALIA.md");
if (process.argv.indexOf("--scrivi") >= 0) {
  fs.writeFileSync(DOPPIE, testo, "utf8");
  var riletto = fs.readFileSync(DOPPIE, "utf8");
