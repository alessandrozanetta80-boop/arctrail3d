...
`node tests/controlla-diari.js` → consegnare**, se il progetto è in sola lettura.
...
`node tests/controlla-diari.js` tiene il tetto: `STATO.md` sotto le 250 righe. Come
