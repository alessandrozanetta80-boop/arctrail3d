 ...
 *
 *   node tests/controlla-token.js [index.html]
 *   node tests/controlla-token.js --fissa   registra i numeri di oggi come tetto
 *
...
var TETTI = [path.join(__dirname, ".tetto-token.json"), path.join(__dirname, "tetto-token.json")];
