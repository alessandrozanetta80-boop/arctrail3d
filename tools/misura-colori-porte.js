 ...
 *
 *   node tools/misura-colori-porte.js fileA.html fileB.html
 *
...
if (FILES.length !== 2) { console.log("  serve: node tools/misura-colori-porte.js A.html B.html"); process.exit(2); }
...
function prepara(file, tag) {
  ...
  fs.writeFileSync(path.join(D, "index.html"),
    require("../tests/copia-dev.js").accendiDev(fs.readFileSync(file, "utf8")));
